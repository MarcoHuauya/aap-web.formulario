package pe.edu.cibertec.aapweb.formulario.controler;
...
import pe.edu.cibertec.aapweb.formulario.model.PromedioModel;
...
public class FormImcController {
    ...
    public String calcularpromedio(
        ...
        model.addAttribute("resultado","Elpromedio de notas es:" + promedio +
